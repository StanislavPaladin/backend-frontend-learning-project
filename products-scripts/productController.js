...
class ProductController {
    async create(req, res) {
        try {
            ...
            const post = await ProductService.create(req.body, req.files.picture1, req.files.picture2, req.files.picture3) //создание поста на основе schema, с использованием полученных в запросе данных
            res.json(post)
        } catch (e) {
